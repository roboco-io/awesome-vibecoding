...
{content}"""
    ...
    # Replace the first heading with our notice + original heading content
    pattern = r'^# .*?$'
    translated_content = re.sub(pattern, notice, translated_content, count=1, flags=re.MULTILINE)
